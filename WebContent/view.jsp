...
<body>
	<%
		...
		int boardID = 0;
		if(request.getParameter("boardID") != null){ // 넘어온 boardID를  boardID에 담아서 처리
		...
		Board board = new BoardDAO().getBoard(boardID); // 0이 아니라면 정보를 board 인스턴스에 담음
	%>
	...
	<div class="container">
		<div class="row">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						...
						<tr>
							<td>내용</td>
							<td colspan="2">
							<div style="min-height: 200px; text-align: left;"><%= board.getBoardContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>")%></div>
							</td>
						</tr>
					</tbody>
				</table>
			<a href = "board.jsp" class="btn btn-primary">목록</a>
				<%
					if(userID != null && userID.equals(board.getUserID())){ // 현재 로그인한 아이디와 작성자의 아이디가 같을경우
				%>
